...
class SedApiService
{
     ...
     */
    public function searchSchools($name)
    {
    ...
    {
        $response = $this->makeRequest('GET', '/schools', $filters);
        return $response['data'] ?? [];
    }

    /**
     * Busca detalhes de uma escola específica
     */
    public function getSchoolDetails($schoolId)
    {
        $response = $this->makeRequest('GET', "/schools/{$schoolId}");
     ...
     */
    public function getSchoolStudents($schoolId, $filters = [])
    {
        $response = $this->makeRequest('GET', "/schools/{$schoolId}/students", $filters);
        return $response['data'] ?? [];
    }
     ...
     */
    public function getSchoolClasses($schoolId, $filters = [])
    {
        $response = $this->makeRequest('GET', "/schools/{$schoolId}/classes", $filters);
        return $response['data'] ?? [];
    }

    /**
     * Busca professores de uma escola específica
     */
    public function getSchoolTeachers($schoolId, $filters = [])
    {
        $response = $this->makeRequest('GET', "/schools/{$schoolId}/teachers", $filters);
        return $response['data'] ?? [];
    }

    /**
     * Busca dados estatísticos de uma escola
     */
    public function getSchoolStats($schoolId)
    {
        $response = $this->makeRequest('GET', "/schools/{$schoolId}/stats");
        return $response['data'] ?? [];
    }
