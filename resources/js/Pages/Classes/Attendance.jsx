...
export default function AttendancePage({ classCode, selectedSchool, today, disciplines = [], userRole }) {
      ...
      header={
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <Link href={
              userRole === 'professor' ? route('classes.my') : route('classes.show', classCode)
